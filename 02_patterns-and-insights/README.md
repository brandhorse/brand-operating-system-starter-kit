...
> What the evidence reveals. Patterns are observed; insights are decisions about what those patterns mean.

**Stage:** `research`  ·  **OS surface:** /app/races/research/patterns

## What goes here

- `patterns/` — Recurring signals across multiple evidence rows.
- `insights/` — Strategic takeaways with attribution to the patterns that prove them.
- `anti-patterns/` — What the data tells you NOT to do — failed positioning, dead audiences, broken claims.
