...
> Deprecated — kept, not deleted. Archive teaches as much as canon: what we tried, why it stopped working, why we stopped.

**Stage:** `archive`

## What goes here

- `deprecated-positioning/` — Old category claims and the evidence that retired them.
- `retired-campaigns/` — Past campaigns with their final performance and lessons.
- `old-assets/` — Superseded logos, voice variants, retired claims.
